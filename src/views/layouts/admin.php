...
<head>
    <title><?= Yii::t('admin', 'Admin Panel') ?></title>
    <?php $this->head() ?>
...
<body class="d-flex flex-column vh-100">
    ...
    <header id="header">
        ...
        echo Nav::widget([
            ...
            'items' => [
                ['label' => Yii::t('admin', 'Index therapists'), 'url' => ['/admin/specialist-request'], 'options' => ['class' => 'px-3']],
                ['label' => Yii::t('admin', 'Blog'), 'url' => ['/admin/article-review'], 'options' => ['class' => 'px-3']],
                ['label' => Yii::t('admin', 'Index summaries'), 'url' => ['/admin/reports'], 'options' => ['class' => 'px-3']],
            ],
        ]);
