    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card">
                <div class="card-body">
                    <p>
                        ...
                        <span class="float-end">
                            ...
                            <?= Html::a(Yii::t('specialist', 'Cancel'), ['cancel-schedule', 'id' => $session->id], ['class' => 'btn btn-danger btn-sm' . $booked]) ?>
                ...
                <?php else: ?>
                    <p class="text-danger">
                            <?= Yii::t('specialist', 'You can create a link to the session in Google Meet within an hour of the scheduled time.') ?>
                    </p>
                <?php endif; ?>
            ...
            <?php else: ?>
                <span class="badge bg-secondary"><?= Yii::t('specialist', 'Booked') ?></span>
            <?php endif; ?>
            </p>
                </div>
            </div>
