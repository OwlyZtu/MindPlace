                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-content text-black text-start row" id="nav-tabContent">
                        <div class="tab-pane fade show active rounded-bottom-5 row " id="nav-profile" role="tabpanel" aria-labelledby="nav-home-profile" tabindex="0">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-6">
                                    <p>
                                        ...
                                        <?= Html::encode(Yii::$app->user->identity->getOptionLabel('city', 'city')) ?>
                                    </p>
                                </div>
                                <div class="col-lg-6">
                                    <p>
                            ...
                            <?php if (Yii::$app->user->identity->social_media): ?>
                                <div class="row mt-4">
                                    <div class="col-lg-6">
                                        <p>
                                    ...
                                    <div class="col-lg-6">
                                        <p>
                                            <?= Yii::$app->user->identity->social_media; ?>
                                        </p>
                                    </div>
                                </div>
                            <? endif; ?>
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row m-2">
                                        ...
                                        <div class="col-lg-7">
                                            <p>
                                                <?= Html::encode(implode(', ', Yii::$app->user->identity->getOptionLabels('specialization', 'specialization'))) ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row m-2">
                                        ...
                                        <div class="col-lg-7">
                                            <p>
                                                <?= Html::encode(implode(', ', Yii::$app->user->identity->getOptionLabels('therapy_types', 'therapy_types'))) ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row m-2">
                                        ...
                                        <div class="col-lg-7">
                                            <p>
                                                <?= Html::encode(implode(', ', Yii::$app->user->identity->getOptionLabels('theme', 'theme'))) ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row m-2">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <p>
                                                <?= Html::encode(implode(', ',  Yii::$app->user->identity->getOptionLabels('format', 'format'))) ?>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row m-2">
                                        ...
                                        <div class="col-lg-7">
                                            <p>
                                                <?= Html::encode(implode(', ', Yii::$app->user->identity->getOptionLabels('language', 'language'))) ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row m-2">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row m-2">
                                        ...
                                        <div class="col-lg-7">
                                            <p>
                                                <?= Html::encode(Yii::$app->user->identity->education_name); ?>
                                            </p>
                                    ...
                                    <?php if (Yii::$app->user->identity->additional_certification): ?>
                                        <div class="row m-2">
                                            <div class="col-lg-5">
                                                <p>
                                            ...
                                            <div class="col-lg-7">
                                                <p>
                                                    <?= Html::encode(Yii::$app->user->identity->additional_certification); ?>
                                                </p>
